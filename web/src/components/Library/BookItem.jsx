...
function BookItem(props) {
    ...
    return (
        <div className={`${props.view === "gallery" ? "flex-col min-h-full" : "min-w-full flex-row"} flex bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-md dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700`}>
            ...
            />
            <div className="flex flex-col gap-2 p-4 leading-normal w-full overflow-hidden">
                <Link to={"/books/" + props.isbn} className="hover:underline dark:decoration-white">
                    <h5 className="text font-bold tracking-tight text-gray-900 dark:text-white">{props.title}</h5>
                </Link>
                <div className="grow">
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    {props.author && props.onAuthorClick ? (
                        <span
                            ...
                            className="cursor-pointer hover:underline focus:outline-none whitespace-nowrap block truncate"
                        >
                ...
                {props.showOptions &&
                    <div className="justify-self-end content-center">
                        <ActionsBookLibraryButton
                            id={props.internalID}
                            onSuccess={props.onReadingStatusChanged}
                            allowNoteEditing={props.allowNoteEditing}
