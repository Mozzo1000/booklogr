...
const BookSkeleton = ({ view, count = 3, showProgress = true }) => {
    return (
        ...
        <div key={i} className={`${view === "gallery" ? "flex-col min-h-full" : "min-w-full flex-row"} flex bg-white border leading-0 border-gray-200 rounded-lg shadow md:flex-row md:max-w-md dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700`}>
