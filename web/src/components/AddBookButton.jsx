    ...
    return (
        ...
        <Tooltip content={t("actions.add_book")}>
            ...
            <Button color="alternative" onClick={() => setOpenAddBookManulModal(true)}><RiAddBoxLine className="w-6 h-6 text-gray-500"/></Button>
                ...
                <Button color="alternative" className="whitespace-nowrap w-fit" onClick={() => setOpenAddBookManulModal(true)}><RiAddBoxLine className="w-6 h-6 mr-1 text-gray-500"/>{t("actions.add_book")}</Button>
            )}
        </Tooltip>
