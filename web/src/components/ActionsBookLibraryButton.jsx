...
function ActionsBookLibraryButton(props) {
    ...
    return (
        ...
        <EditBookModal id={props.id} totalPages={props.totalPages} open={openEditBookModal} close={setOpenEditBookModal} onSuccess={props.onSuccess} author={props.author} title={props.title} subtitle={props.subtitle} isbn={props.isbn} description={props.description} readingStatus={props.readingStatus}/>
